...
**Response**: Gentoo's flipper length is longer than other two species.
...
**Response**:I can easily see the average in the boxplot. While I can easily notice the frequency of the data and how it groups together.
